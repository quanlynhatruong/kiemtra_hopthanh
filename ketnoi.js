...
// Bọc try-catch chống sập hệ thống khi Chrome chặn Storage
let USER_EMAIL = "";
try { USER_EMAIL = sessionStorage.getItem("SKT_USER_EMAIL") || ""; } catch(e) { console.warn("Chrome chặn Storage khởi tạo"); }
        ...
        get: function(target, prop) {
            ...
            return function(...args) {
                try {
                    ...
                    USER_EMAIL = window.SKT_GLOBAL_EMAIL || "";
                }
...
function executeBackend(action, argsArray, onSuccess, onFailure) {
    ...
    else if (action === "SKT_getInitialData") params = { email: argsArray[0], ts: argsArray[1] };
